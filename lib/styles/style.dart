...
const PageHeaderStyle = TextStyle(fontWeight: FontWeight.bold);

const BodyStyle = TextStyle(
    fontSize: 15.0, color: Colors.indigoAccent, fontWeight: FontWeight.bold);
...
const ListItemStyle = TextStyle(fontSize: 14.0); 
